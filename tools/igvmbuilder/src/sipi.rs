...
pub fn add_sipi_stub(compatibility_mask: u32, directives: &mut Vec<IgvmDirectiveHeader>) {
    ...
    // F060: 0F 30                          wrmsr
    // 1:
    // F062: 0F 20 E0                       mov eax, cr4
    // F065: 83 C8 20                       or eax, 20h // CR4_PAE
    // F068: 0F 22 E0                       mov cr4, eax
    // F06B: 0F 20 C0                       mov eax, cr0
    // F06E: 0F BA E8 1F                    bts eax, 1Fh
    // F072: 0F 22 C0                       mov cr0, eax // CR0_PG
    // F075: BF 00 00 01 00                 mov edi, 10000
    // F07A: 2B 3D FC FF 00 00              sub edi, [FFFC] // context size
    // F080: EA 87 F0 00 00 10 00           jmp 0010:F087
    // F087: FF 25 63 0F 00 00              jmp [FFF0] // start routine
    // F08D:
    ...
    let code_bytes: &[u8] = &[
        ...
        0x0F, 0xBA, 0xE8, 0x08, 0x72, 0x02, 0x0F, 0x30, 0x0F, 0x20, 0xE0, 0x83, 0xC8, 0x20, 0x0F,
        0x22, 0xE0, 0x0F, 0x20, 0xC0, 0x0F, 0xBA, 0xE8, 0x1F, 0x0F, 0x22, 0xC0, 0xBF, 0x00, 0x00,
        0x01, 0x00, 0x2B, 0x3D, 0xFC, 0xFF, 0x00, 0x00, 0xEA, 0x87, 0xF0, 0x00, 0x00, 0x10, 0x00,
        0xFF, 0x25, 0x63, 0x0F, 0x00, 0x00,
    ];
