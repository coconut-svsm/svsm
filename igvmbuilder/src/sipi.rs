...
pub fn add_sipi_stub(compatibility_mask: u32, directives: &mut Vec<IgvmDirectiveHeader>) {
    ...
    // F009: 2E 66 0F 01 16 1A 00 00 00     lgdt cs:[001A]
    // F012: EA 40 F0 00 00 08 00           jmp 0008:F040
    // F019: CC
    ...
    // F05E: 0F 30                          wrmsr
    // F060: 0F 20 C0                       mov eax, cr0
    // F063: 0F BA E8 1F                    bts eax, 1Fh
    // F067: 0F 22 C0                       mov cr0, eax // CR0_PG
    // F06A: EA 71 F0 00 00 10 00           jmp 0010:F071
    // F071: 48 8B 25 78 0F 00 00           mov rsp, [FFF0] / stack pointer
    // F078: BF 00 00 01 00                 mov edi, 10000
    // F07D: 2B 3D 79 0F 00 00              sub edi, [FFFC] // context size
    // F083: FF 15 5F 0F 00 00              call [FFE8] // transition routine
    // F089: FF 25 51 0F 00 00              jmp [FFE0] // start routine
    // F08F:

    let code_bytes: &[u8] = &[
        0x0F, 0x20, 0xC0, 0x80, 0xC8, 0x01, 0x0F, 0x22, 0xC0, 0x2E, 0x66, 0x0F, 0x01, 0x16, 0x1A,
        0x00, 0x00, 0x00, 0xEA, 0x40, 0xF0, 0x00, 0x00, 0x08, 0x00, 0xCC, 0x1F, 0x00, 0x20, 0xF0,
        ...
        0x0F, 0xBA, 0xE8, 0x08, 0x0F, 0x30, 0x0F, 0x20, 0xC0, 0x0F, 0xBA, 0xE8, 0x1F, 0x0F, 0x22,
        0xC0, 0xEA, 0x71, 0xF0, 0x00, 0x00, 0x10, 0x00, 0x48, 0x8B, 0x25, 0x78, 0x0F, 0x00, 0x00,
        0xBF, 0x00, 0x00, 0x01, 0x00, 0x2B, 0x3D, 0x79, 0x0F, 0x00, 0x00, 0xFF, 0x15, 0x5F, 0x0F,
        0x00, 0x00, 0xFF, 0x25, 0x51, 0x0F, 0x00, 0x00,
    ];
