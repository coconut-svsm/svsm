...
## Note that steps 7 and 8 should be skipped until VTPM state file linking is implemented.
...
## 7. [Optional] Use [tpm provisioner](https://github.com/armenon-rh/tpm_provisioner) to create an NVChip file.
### Skip if VTPM state file linking not needed
...
## 8. [Optional] Use [vtpm-to-svsm-blk](https://github.com/armenon-rh/vtpm-to-svsm-blk) to create a virtio block image.
### Skip if VTPM state file linking not needed
