...
impl PageTable {
    ...
    ///
    /// # Errors
    /// Returns `SvsmError` if the operation fails.
    ///
    ...
    /// Unmaps a region of memory using 2MB pages.
    ///
    /// # Parameters
    /// - `vregion`: The virtual memory region to unmap.
    ///
    ...
    /// Populates a part of the page table with the specified attributes.
    ///
    /// # Parameters
    /// - `part`: The part of the page table to populate.
    ///
...
impl PageTableRef {
    /// Creates a new [`PageTableRef`].
    ///
    /// # Parameters
    /// - `pgtable_ptr`: A raw pointer to a [`PageTable`].
    ///
    /// # Returns
    /// A new [`PageTableRef`].
    ///
