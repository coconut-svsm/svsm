...
use crate::vtpm::{SvsmVTpmError, tcgtpm::{TcgTpmSimulatorInterface, TPM_BUFFER_MAX_SIZE}};
...
///              sending the command.
pub fn checked_send<T: TcgTpmSimulatorInterface>(vtpm: &T, cmd: &mut [u8], set_len: bool) -> Result<(), SvsmVTpmError> {
...
pub fn create_ek<T: TcgTpmSimulatorInterface>(vtpm: &T, tpmt_public: &[u8]) -> Result<Vec<u8>, SvsmVTpmError> {
