...
/// Allocate a u8 Vec of a certain size. Alternative to the `vec!` macro that panics if enough bytes
/// to allocate the corresponding Vec isn't available.
pub fn u8_vec_sized(size: usize) -> Result<Vec<u8>, TryReserveError> {
