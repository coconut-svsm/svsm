...
/// # Returns
///
/// * `MmioSlots` - Collection of discovered VirtIO devices.
///
...
/// must only happen once during system initialization. Otherwise, if the same slot
/// is probed and/or used by two different drivers, this can cause unexpected behaviours.
