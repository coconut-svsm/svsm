...
use super::common::{
    load_idt, Idt, IdtEntry, X86Regs, BP_VECTOR, DF_VECTOR, GLOBAL_IDT, GP_VECTOR, PF_VECTOR,
    SVM_EXIT_EXCP_BASE, VC_VECTOR, X86_TRAP_DB,
};
...
#[no_mangle]
pub fn generic_idt_handler(regs: &mut X86Regs) {
