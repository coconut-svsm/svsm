...
use super::def::{
    SYS_MKDIR, SYS_OPEN, SYS_OPENDIR, SYS_READ, SYS_READDIR, SYS_RMDIR, SYS_SEEK, SYS_TRUNCATE,
...
pub fn open(path: &CStr, mode: usize, flags: usize) -> Result<FsObjHandle, SysCallError> {
...
pub fn seek(fd: &FsObjHandle, offset: i64, flags: usize) -> Result<u64, SysCallError> {
    // SAFETY: Invokes a system call and does not directly change any memory of
    // the process.
