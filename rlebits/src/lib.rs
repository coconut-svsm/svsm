...
#[derive(Debug, Clone)]
pub struct RleBits {
    runs: Vec<usize>, // Alternating run lengths, starting with 0s at index 0
    limit: usize,     // Upper limit of values, exclusive (ie, 0-9 is represented by 10)
    max_run: usize,   // Maximum runs index currently in use
}
...
impl RleBits {
    ...
    pub fn get(&self, index: usize) -> Option<bool> {
        ...
        debug_assert!(false, "RleBits::get() - fell through all runs");
